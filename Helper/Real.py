...
model = Sequential()
model.add(LSTM(64, return_sequences=True, activation='relu', input_shape=(20,126)))  # (30,126)
...
filepath = "lstm_model_20_best_new_35_0.9635791182518005.h5"
...
model.load_weights('lstm_model_20_best_new_35_0.9635791182518005.h5')
